                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className={`px-3 py-1 rounded-full text-xs font-bold tracking-wider border flex items-center gap-1.5 ${
                                        ...
                                        <Info size={12} />
                                        {row.predictions.forecast.confidence.toUpperCase()} CONFIDENCE
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                                ...
                                <div className="md:col-span-4 space-y-3">
                                    ...
                                    <div className="flex justify-between text-xs font-mono text-slate-400">
                                        <span>Spent: {formatCurrency(row.current_status.spent).split('.')[0]}</span>
                                        <span>Alloc: {formatCurrency(row.current_status.allocation).split('.')[0]}</span>
                                    </div>
                                </div>
                                ...
                                <div className="md:col-span-3">
                                    <div className="bg-slate-900 rounded-xl p-3 border border-slate-800 shadow-inner">
                                        ...
                                        <div className="flex items-baseline gap-2">
                                            <span className="text-2xl font-black text-white">{formatCurrency(row.predictions.forecast.predicted_unspent).split('.')[0]}</span>
